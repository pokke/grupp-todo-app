          ...
          >
            {editTodo && editTodo.id === todo.id ? (
              ...
              <div className="title-container">
                ...
                {todo.dueDate &&
                  new Date(todo.dueDate) - new Date() > dueSoonDate && (
                    <div className="due">Due {todo.dueDate}</div>
                  )}
                {todo.dueDate &&
                  new Date(todo.dueDate) - new Date() <= dueSoonDate &&
                  new Date(todo.dueDate) > new Date() && (
                    <div className="due-soon">Due {todo.dueDate} - Soon</div>
                  )}
                {todo.dueDate && new Date(todo.dueDate) <= new Date() && (
                  <div className="overdue">Due {todo.dueDate} - Overdue</div>
                )}
              </div>
            )}
